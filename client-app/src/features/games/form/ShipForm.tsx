            ...
            <Formik
                ...
                {({handleSubmit, isSubmitting: isSubmitting}) => (
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        {size > 1 && <MySelectInput options={directionOptions} name='direction' placeholder='Direction' />}
                        ...
                        <Button
                            ...
                            type='submit'
                            content='Submit'/>
                        <Button onClick={onCancel} as={Link} to={`/game/${id}`} floated='right' type='button' content='Cancel'/>
                    </Form>
                )}
            </Formik>
        </Segment>
